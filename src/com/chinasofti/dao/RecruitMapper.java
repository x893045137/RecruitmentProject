...
public interface RecruitMapper {
	...
	List<Recruitinfo> selectRecruits(@Param("recruit") Recruitinfo recruit,@Param("currage") Integer currage,@Param("page") Integer page);
	
	//List<Recruitinfo> selectRecruits(Recruitinfo recruit);

	List<Recruitinfo> selectAllRecruits(@Param("recruit") Recruitinfo recruit);
