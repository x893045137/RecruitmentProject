...
<link href="../css/personal/public/base.css?20170619" rel="stylesheet"
	type="text/css" />
<link href="../css/personal/public/form.css?20170619" rel="stylesheet"
	type="text/css" />
<link href="../css/personal/public/panel-pop.css?20170619"
	rel="stylesheet" type="text/css" />
<link href="../css/personal/my/my51.css?20170619" rel="stylesheet"
	type="text/css" />
...
<script language="javascript"
	src="../js/personal/resume/RefreshResume.js?20170504?20170619"></script>
<script language="javascript"
	src="../js/personal/my/my_51job.js?20170504?20170619"></script>
<script language="javascript"
	src="../js/personal/resume/modify_userinfo.js?20170627?20170619"></script>
<script language="javascript"
	src="../js/personal/login/mobile_original.js?20170619"></script>
<script language="javascript"
	src="../js/personal/my/my_collection.js?20170504?20170619"></script>
<script language="javascript" src="../js/personal/my/my.js?20170619"></script>
<script language="javascript"
	src="../js/personal/delivery.js?20170504?20170619"></script>
<script language="javascript"
	src="../js/personal/my/pointtrack_my.js?20170706?20170619"></script>
<script language="javascript"
	src="../js/personal/pointtrack.js?20170623?20170619"></script>
<script language="javascript"
	src="../js/personal/login/d_nation.js?20170619"></script>
</head>
<body>
	<div class="header">
		<!-- bar start -->
	...
	<div class="content">
		...
		<div class="exlt">
			<a track-type="trackIndexClick" event-type="28"
				href="Myjob.action?userid=${consumer.id }" class="on"><span>我的51Job</span></a>
			<!-- <a track-type="trackIndexClick" event-type="29" href="description.jsp" class=""><span>简历中心</span></a> -->
			<a track-type="trackIndexClick" event-type="30"
				href="resume_browsed.jsp?lang=c" class=""><span>谁看过我</span></a> <a
				track-type="trackIndexClick" event-type="32"
				href="selectApply.action?userid=${consumer.id }" class=""><span>我的申请<em
					class="new"></em></span></a>
		</div>
		<script>
			$('.mbtn').click(function() {
		...
		<input type="hidden" id="pageCode" value="11203">
		<div class="exrt">
			...
			<div class="resume">
				<div class="rview">
					...
					<div class="rmsg clearfix">
						<div class="rli">
							<img src="http://images.51job.com/im/2016/resume/man.png"
								alt="头像" width="85" height="104">

							<div class="rcon">
								<div class="h1 e2">
									<a href="javascript:void(0);"
										onclick="edit(354961236,0,'http://i.51job.com/resume')">我的简历</a>
								</div>
								<c:choose>
									<c:when test="${ ! empty UserBasic }">
										<div class="r1">
											<span title="">${UserBasic.ub_username }&nbsp;&nbsp;|&nbsp;&nbsp;${UserBasic.sex }&nbsp;&nbsp;|&nbsp;&nbsp;${UserBasic.age }岁&nbsp;&nbsp;|&nbsp;&nbsp;现居住${UserBasic.ub_address }</span>
										</div>
									</c:when>
									<c:otherwise>
										<div class="r1">
											<span>暂无简历信息，快去建立简历吧！</span>
										</div>
									</c:otherwise>
								</c:choose>
							...
							<div class="btnbox">
								<span class="p_but geige" track-type="trackButtonClick"
									event-type="3"
									onclick="goUserBasic('${id}')">编辑</span>
								<form id="goUserBasicform" action="goupdateUserBasic.action"
									method="post">
									<!-- 	<input type="hidden" id="ubname" name="ub_username" />
                                		<input type="hidden" id="ubsex" name="sex" />
                                		<input type="hidden" id="ubage" name="age" />
                                		<input type="hidden" id="ubaddrs" name="ub_address" /> -->
									<input type="hidden" id="ubuserid" name="id">
								</form>
							</div>
						</div>
					...
					<div class="page clearfix">
						<a class="pli on"></a> <a class="pli"></a>
				...
				<div class="rsee clearfix">
					<div class="rsl">
						<a track-type="trackButtonClick" event-type="4"
							href="http://i.51job.com/userset/resume_browsed.php?lang=c">谁看过我
							<span class="c_orange"></span>
						</a>
					</div>
					<div class="rsl r1">
						<a track-type="trackButtonClick" event-type="5"
							href="selectApply.action?userid=${consumer.id }">我的申请 <span
							class="c_orange">${size }</span></a>
					</div>
		...
		</a> <a href="http://i.51job.com/userset/advice.php?from=my51job"
