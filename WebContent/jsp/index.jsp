...
<body bgcolor="#FFFFFF">
				...
				<c:choose>
					<c:when test="${! empty consumer  }">
						<div class="uer">
							...
							<!-- 1.选项栏 -->
							<ul>
								<li class="tle"><span><a href="pindex.jsp">我的51Job</a><em
										class="icon_arrow"></em></span></li>
								<li class="e1 e_icon"><a onclick="jlzx('${consumer.id}')" >简历中心</a>
									<form id="goUserBasic" action="goupdateUserBasic.action" method="post">
			...
			<div class="in">
				...
				<p class="nlink">
					<a class="on" href="index.jsp">首页</a> <a class=""
						href="search_result.jsp">职位搜索</a> <a class=""
	...
	<div class="content"
		...
		<div class="in Fm">
			<input type="hidden" id="showguide" value="2" /> <input
				type="hidden" id="showlayer" value="2" /> <input type="hidden"
				id="language" value="c" />
			<div class="fltr radius_5">
				<div class="ush top_wrap">
					<div class="el on">
						<p class="ipt">
							<input type="text" maxlength="200" id="kwdselectid"
								placeholder="请输入关键字" vindex="-1" value="" class="mytxt at">
						</p>
					</div>
					<button onclick="kwdGoSearch($('#kwdselectid').val());">搜索</button>
					<a class="more"
						href="http://search.51job.com/jobsearch/advance_search.php">高级<br>搜索
					</a>
				</div>

				<p class="ht" track-type="recommendKeyword" recommend-type="1">
					热门推荐：<a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E9%2594%2580%25E5%2594%25AE,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">销售</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,java,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">java</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E4%25BA%25BA%25E4%25BA%258B,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">人事</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E4%25BC%259A%25E8%25AE%25A1,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">会计</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,UI,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">UI</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E5%25B9%25B3%25E9%259D%25A2%25E8%25AE%25BE%25E8%25AE%25A1,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">平面设计</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E8%25A1%258C%25E6%2594%25BF,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">行政</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,web%25E5%2589%258D%25E7%25AB%25AF,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">web前端</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E6%2588%25BF%25E5%259C%25B0%25E4%25BA%25A7,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">房地产</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E5%25A4%2596%25E8%25B4%25B8,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">外贸</a><a
						href="http://search.51job.com/list/020000,000000,0000,00,9,99,%25E6%2597%25A5%25E8%25AF%25AD,2,1.html?lang=c&degreefrom=99&stype=&workyear=99&cotype=99&jobterm=99&companysize=99&radius=-1&address=&lonlat=&postchannel=&list_type=&ord_field=&curr_page=&dibiaoid=0&landmark=&welfare=">日语</a>
				</p>
				<p class="lks"></p>
			</div>
