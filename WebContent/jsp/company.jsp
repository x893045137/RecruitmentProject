			...
			<div class="in">
				...
				<p class="nlink">
					<a class="" href="index.jsp">首页</a>
					 <a class="" href="selectRecruit.action?lang=c&salary=${salary }&companyNature=${companyNature }&WorkExperience=${WorkExperience }&Recordschool=${Recordschool }&companySize=${companySize }&companyLocation=${companyLocation }&welfare=${welfare }&worktype=${worktype}&worktype=${worktype}&keyword =${keyword}">职位搜索</a>
