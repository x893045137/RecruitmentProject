							...
							<form id="userloginform" action="userlogin.action" method="post">
								<div class="c-lrform">
									<div class="c-lrinline">
										<label class="c-lrlabel">用户名：<span></span></label> <input
											class="c-lrinputpsd" id="userloginname" type="text"
											name="username" placeholder="请输入用户名" />
									</div>
									<div class="c-lrinline">
										<label class="c-lrlabel">密码：<span></span></label> <input
											class="c-lrinputpsd" id="userloginpsd" type="password"
									...
									<div class="c-lrinline">
										<input class="c-lrsubmit" id="userlogin-sub" type="button"
											value="登 录" />
									</div>
									<div class="c-lrinline">
										<span
											style="width: 100%; float: left; font-size: 16px; text-align: center;">还没有账户去
											<a href="./index-register.jsp" style="color: #ff6000">注册</a>？
										</span>
									</div>
								</div>
							</form>
				...
				<div class="c-loginright" id="qiyelogin" style="display: none;">
					...
					<div class="c-lrlogin">
						<div class="c-lrtopt">
							企业登录 <span
								style="float: right; font-size: 14px; margin-top: 8px;"><a
								id="user-login" href="#">用户登录</a></span>
						</div>
						<form id="qiyeloginform" action="qiyelogin.action" method="post">
							<div class="c-lrform">
								<div class="c-lrinline">
									<label class="c-lrlabel">用户名：<span></span></label> <input
										class="c-lrinputpsd" id="qiyeloginname" type="text"
										name="enterprisename" placeholder="请输入用户名" />
								</div>
								<div class="c-lrinline">
									<label class="c-lrlabel">密码：<span></span></label> <input
										class="c-lrinputpsd" id="qiyeloginpsd" type="password"
										name="enterprisepwd" placeholder="请输入密码" />
								</div>
								<!--<div class="c-lrinline">
										<span style="line-height: 20px;"><input type="checkbox" style="vertical-align:middle; margin-top:-1px; margin-bottom:1px;"/> 自动登录</span>
										<span style="float: right;"><a href="#" class="c-lrccolor1">忘记密码</a>？</span>
								...
								<div class="c-lrinline">
									<input class="c-lrsubmit" id="qiyelogin-sub" type="button"
										value="登 录" />
								</div>
								<div class="c-lrinline">
									<span
...
<script type="text/javascript">
	...
	$("#userlogin-sub").click(
			function() {
				if ($("#userloginname").val().length == 0
						|| $("#userloginpsd").val().length == 0) {
					alert("用户名或密码不能为空")
				} else {
	...
	$("#qiyelogin-sub").click(
			function() {
				if ($("#qiyeloginname").val().length == 0
						|| $("#qiyeloginpsd").val().length == 0) {
					alert("用户名或密码不能为空");
				} else {
