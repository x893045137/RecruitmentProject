function Refreshresume(ReSumeID,Lang,DOMAIN_MY)
{
	...
	if(Lang == "e")
	{
		var html = '<div class="panel_lnp panel_py"><h2><p>Adivce</p><a class="layer_close" href="#"><i></i></a></h2><div class="pannel_con"><div class="gp3"><strong class="wd f16 center c_orange">Resume updated!</strong></div></div></div>';
	}
	else
	{
